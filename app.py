...
# Create a unique key for the chat input widget
user_input = st.chat_input("Type your message here:", key="unique_chat_input_key")
...
# Optional: Display full conversation history (for debugging purposes)
if st.checkbox("Show Full Conversation History", key="unique_checkbox_key"):
